...
public class Excel {
    ...
    public HSSFWorkbook libroV;
    public HSSFSheet hojaV;
    public HSSFRow filaV;
    public HSSFCell celdaV;

    public Excel(){
        libro = new XSSFWorkbook();
    }
    
    public Excel(boolean valor){
    ...
    public Sheet dameHoja(String nombre){
        return libro.createSheet(nombre);
    }
    
    public void crearHojaV(String nombre){
        hojaV = libroV.createSheet(nombre);
    }
    ...
    public void traerHojaV(int ubi){
        hoja = libroV.getSheetAt(ubi);
    }
    ...
    public HSSFRow agregarFilaV(int ubicacion){
        return filaV = hojaV.createRow(ubicacion);
    }
    ...
    public HSSFRow traerFilaV(int ubicacion){
        return filaV = hojaV.getRow(ubicacion);
    }
    ...
    public HSSFCell agregarCeldaV(int i, HSSFRow f){
        celdaV = f.createCell(i);
        adaptarCeldaV(i);
        return celdaV;
    }
    public HSSFCell traerCeldaV(int ubicacion){
        return celdaV = filaV.getCell(ubicacion);
    }
    ...
    public void adaptarCeldaV(int col){
        hojaV.autoSizeColumn(col);
    }
